...
cuneus_remote_bin!(
    ...
    ShaderParams,
    f32: [
        lambda, theta, alpha, sigma, gamma, blue, a, b,
        base_color_r, base_color_g, base_color_b, accent_color_r, accent_color_g,
        accent_color_b, background_r, background_g, background_b,
        gamma_correction, aces_tonemapping
    ],
    color3: []
);
