...
impl ShaderManager for SystemShader {
    fn init(core: &Core) -> Self {
        ...
        let compute_shader = acuneus::compute_shader!(core, "shaders/system.wgsl", config);
        ...
        Self {
            ...
            remote: acuneus::remote::RemoteRuntime::new("system", 800, 600),
        }
    }
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (app, event_loop) = acuneus::ShaderApp::new("Attractor Universe", 800, 600);
